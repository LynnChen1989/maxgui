...
export default {
    data() {
        return {
            tableHeaders: [
                { text: `集群`, value: 'groupId' },
                { text: '状态', value: 'monitorState' },
                { text: '服务器', value: 'id' },
                { text: '地址', value: 'serverAddress' },
                { text: '端口', value: 'serverPort' },
                { text: '连接', value: 'serverConnections' },
                { text: '状态', value: 'serverState' },
                { text: 'GTID', value: 'gtid' },
                { text: '服务', value: 'serviceIds' },
            ],
            servicesLength: 0,
            monitorsLength: 0,
        }
